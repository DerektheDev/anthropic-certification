...
def run_prompt(prompt_inputs):
    ...
    **For: 180 cm, 75 kg Vegetarian Athlete**

    ---

    ## Daily Nutrition Targets
    - **Calories:** 2,800-3,000 kcal
    - **Protein:** 150-165g (2.0-2.2g per kg)
    - **Carbohydrates:** 350-375g
    - **Fat:** 85-95g
    ...
    ### **BREAKFAST** (7:00 AM)
    *~650 calories | 28g protein | 80g carbs | 16g fat*

    - Oatmeal (80g dry) with water
    - Whole eggs (3 large)
    - Banana (150g)
    - Almond butter (15g)
    - Honey (10g)
    ...
    *~320 calories | 28g protein | 35g carbs | 7g fat*

    - Greek yogurt (200g, non-fat)
    - Granola (35g)
    - Berries (80g mixed)
    ...
    ### **LUNCH** (1:00 PM)
    *~750 calories | 42g protein | 90g carbs | 18g fat*

    - Lentils (150g cooked)
    - Chickpea pasta (150g cooked)
    - Spinach (120g, sautéed)
    - Olive oil (12g)
    ...
    *~290 calories | 18g protein | 48g carbs | 3g fat*
    ...
    ### **DINNER** (7:00 PM)
    *~700 calories | 48g protein | 65g carbs | 22g fat*

    - Tofu (200g, pan-fried)
    - Sweet potato (250g, baked)
    - Broccoli (150g, steamed)
    - Tahini dressing (15g tahini + lemon)
    - Mixed green salad (100g)

    ---

    ### **EVENING SNACK** (9:30 PM)
    *~200 calories | 28g protein | 8g carbs | 5g fat*

    - Casein protein shake (35g powder)
    ...
    ✓ Time carbs around workout (pre & post)
    ✓ Rotate protein sources: tofu, lentils, chickpeas, Greek yogurt, eggs
    ✓ Stay hydrated (3-4 liters daily)
    ✓ Adjust portions based on hunger and training intensity
    ✓ Budget-friendly with pantry staples like lentils, chickpeas, and oats
    </ideal_output>
    """
    # Follow these steps:
